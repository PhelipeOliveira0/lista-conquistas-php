...
<header>
    ...
    <section class="formulario">
        <form action=/update-descricao-conquista?id=<?=$id;?> method="post" class="formulario__edit">
            <label for="descricao" class="formulario__label">Nova descricao:</label>
            <textarea class="formulario__descricao" name="descricao" id="" cols="80" rows="20" required></textarea>
